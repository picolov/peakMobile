...
public class MainMenu extends AppCompatActivity {
    ...
    private MainMenu.AdapterImageSlider adapterImageSlider;
    ...
    private void initComponent() {
        ...
        adapterImageSlider = new MainMenu.AdapterImageSlider(this, new ArrayList<Image>());
    ...
    private static class AdapterImageSlider extends PagerAdapter {
        ...
        private MainMenu.AdapterImageSlider.OnItemClickListener onItemClickListener;

        private interface OnItemClickListener {
            void onItemClick(View view, Image obj);
        }

        public void setOnItemClickListener(MainMenu.AdapterImageSlider.OnItemClickListener onItemClickListener) {
